...
package custom_axi_ip_reg_pkg;
  ...
  typedef struct packed {logic [31:0] q;} custom_axi_ip_reg2hw_data_mreg_t;
  ...
  parameter logic [BlockAw-1:0] CUSTOM_AXI_IP_DATA_0_OFFSET = 4'h0;

  parameter logic [BlockAw-1:0] CUSTOM_AXI_IP_DATA_1_OFFSET = 4'h4;
  ...
  parameter logic [3:0] CUSTOM_AXI_IP_PERMIT[4] = '{
      ...
      4'b1111,  // index[0] CUSTOM_AXI_IP_DATA_0

      4'b1111,  // index[1] CUSTOM_AXI_IP_DATA_1
