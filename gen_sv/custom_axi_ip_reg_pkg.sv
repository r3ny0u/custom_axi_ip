...
package custom_axi_ip_reg_pkg;
  ...
  typedef struct packed {
    logic [31:0] q;
  } custom_axi_ip_reg2hw_data_reg_t;
  ...
  // Register offsets
  parameter logic [BlockAw-1:0] CUSTOM_AXI_IP_DATA_OFFSET = 4'h 0;
  parameter logic [BlockAw-1:0] CUSTOM_AXI_IP_ENABLE_OFFSET = 4'h 4;
  parameter logic [BlockAw-1:0] CUSTOM_AXI_IP_STATUS_OFFSET = 4'h 8;
  ...
  parameter logic [3:0] CUSTOM_AXI_IP_PERMIT [3] = '{
    4'b 1111, // index[0] CUSTOM_AXI_IP_DATA
    4'b 0001, // index[1] CUSTOM_AXI_IP_ENABLE
    4'b 0001  // index[2] CUSTOM_AXI_IP_STATUS
  };
