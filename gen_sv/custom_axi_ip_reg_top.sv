...
module custom_axi_ip_reg_top #(
  ...
  always_comb begin
    addr_hit = '0;
    addr_hit[0] = (reg_addr == CUSTOM_AXI_IP_DATA_OFFSET);
    addr_hit[1] = (reg_addr == CUSTOM_AXI_IP_ENABLE_OFFSET);
    addr_hit[2] = (reg_addr == CUSTOM_AXI_IP_STATUS_OFFSET);
  end
  ...
  assign data_we   = addr_hit[0] & reg_we & !reg_error;
